...
func TestCreate(t *testing.T) {
	t.Run("create successfully", func(t *testing.T) {
		...
		result, err := repo.Create(ctx, models.Scope{}, region.CreateOptions{Name: "Test Region"})
	...
	t.Run("create with error", func(t *testing.T) {
		...
		repo := &implRepository{db: mockDB, l: &mockLogger{}}
		_, err := repo.Create(ctx, models.Scope{}, region.CreateOptions{})
...
func TestGetByID(t *testing.T) {
	t.Run("get successfully", func(t *testing.T) {
		...
		expected := models.Region{ID: id, Name: "Test Region"}
...
func TestUpdate(t *testing.T) {
	t.Run("update successfully", func(t *testing.T) {
		ctx := context.Background()
		id := primitive.NewObjectID()
		updated := models.Region{ID: id, Name: "Updated"}
		...
		repo := &implRepository{db: mockDB, l: &mockLogger{}}
		result, err := repo.Update(ctx, models.Scope{}, region.UpdateOptions{ID: id, Name: "Updated"})
	...
	t.Run("update with error", func(t *testing.T) {
		...
		repo := &implRepository{db: mockDB, l: &mockLogger{}}
		_, err := repo.Update(ctx, models.Scope{}, region.UpdateOptions{ID: id})
...
func TestHasBranches(t *testing.T) {
	t.Run("has branches", func(t *testing.T) {
		ctx := context.Background()
		...
		repo := &implRepository{db: mockDB, l: &mockLogger{}}
		result, err := repo.HasBranches(ctx, primitive.NewObjectID())
